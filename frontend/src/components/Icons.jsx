...
export const SpeakerIcon = ({ className = 'h-4 w-4' }) => (
  <svg {...base} className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.5a.75.75 0 01-.75-.75V9a.75.75 0 01.75-.75h2.25z" />
  </svg>
);

export const ChatBubbleIcon = ({ className = 'h-4 w-4' }) => (
  <svg {...base} className={className}>
...
export const RepeatIcon = ({ className = 'h-4 w-4' }) => (
  <svg {...base} className={className}>
